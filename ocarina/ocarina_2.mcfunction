...
#Extendet Song of Time
execute if entity @s[nbt={Inventory:[{id:"minecraft:tnt_minecart",Count:1b}]}] run function ocarina_of_time:items/ocarina/custom_songs/extendetsot
#Finish
